package com.VerifyApplicationStatus.helper;
...
public class BrowserMethods 
{
	...
	public void beforeSuite()
	{
		...
		extentHtmlReporter = new ExtentHtmlReporter(new File(System.getProperty("user.dir")+File.separator+"Reports"+File.separator+"ApplicationStatusReport_"+new SimpleDateFormat("dd_MM_YYY_HH_mm").format(new Date())+".html"));
	...
	public String captureScreenshot(String name) throws IOException
	{
		...
		String path = System.getProperty("user.dir")+File.separator+"Reports"+File.separator+name+new SimpleDateFormat("dd_MM_YYYY_HH_mm").format(new Date())+".jpg";
